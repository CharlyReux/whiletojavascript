...
import paramInterpreter.inter.parser.antlr.MyDslAntlrTokenFileProvider;
import paramInterpreter.inter.parser.antlr.MyDslParser;
import paramInterpreter.inter.parser.antlr.internal.InternalMyDslLexer;
import paramInterpreter.inter.scoping.MyDslScopeProvider;
import paramInterpreter.inter.serializer.MyDslSemanticSequencer;
import paramInterpreter.inter.serializer.MyDslSyntacticSequencer;
import paramInterpreter.inter.services.MyDslGrammarAccess;
import paramInterpreter.inter.validation.MyDslConfigurableIssueCodesProvider;
import paramInterpreter.inter.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "paramInterpreter/inter/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("paramInterpreter.inter.MyDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("inter");
	}

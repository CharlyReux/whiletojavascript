 ...
 * </p>
 * <ul>
 *   <li>{@link paramInterpreter.inter.myDsl.impl.EBlistImpl#getLexpb <em>Lexpb</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EBlistImpl extends MinimalEObjectImpl.Container implements EBlist
{
  ...
  public EList<ExprBase> getLexpb()
  {
    if (lexpb == null)
    {
      lexpb = new EObjectContainmentEList<ExprBase>(ExprBase.class, this, MyDslPackage.EBLIST__LEXPB);
    }
    return lexpb;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.EBLIST__LEXPB:

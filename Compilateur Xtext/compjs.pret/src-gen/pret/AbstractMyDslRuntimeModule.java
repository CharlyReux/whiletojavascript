...
import pret.parser.antlr.MyDslAntlrTokenFileProvider;
import pret.parser.antlr.MyDslParser;
import pret.parser.antlr.internal.InternalMyDslLexer;
import pret.scoping.MyDslScopeProvider;
import pret.serializer.MyDslSemanticSequencer;
import pret.serializer.MyDslSyntacticSequencer;
import pret.services.MyDslGrammarAccess;
import pret.validation.MyDslConfigurableIssueCodesProvider;
import pret.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "pret/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("pret.MyDsl");
	}

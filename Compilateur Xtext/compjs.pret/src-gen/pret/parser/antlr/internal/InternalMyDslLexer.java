...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_SYMBOL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1674:13: ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* ( '!' | '?' )? )
            // InternalMyDsl.g:1674:15: 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* ( '!' | '?' )?
            {
            matchRange('a','z'); 
            // InternalMyDsl.g:1674:24: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_VARIABLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1676:15: ( 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* ( '!' | '?' )? )
            // InternalMyDsl.g:1676:17: 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* ( '!' | '?' )?
            {
            matchRange('A','Z'); 
            // InternalMyDsl.g:1676:26: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_RCHARIOT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1678:15: ( '\\n' )
            // InternalMyDsl.g:1678:17: '\\n'
            {
            match('\n'); 

...
public class MyDelegateGenerator extends GeneratorDelegate {
	...
	public void generate(Resource input, IFileSystemAccess2 fsa, IGeneratorContext context,String outFile) {
		try {
			beforeGenerate(input, fsa, context);
			generator.doGeneratIndent(input, fsa, context,outFile);
		} finally {
